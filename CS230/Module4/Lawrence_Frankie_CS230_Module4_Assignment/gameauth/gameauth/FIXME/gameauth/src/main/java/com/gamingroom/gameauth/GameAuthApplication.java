...
// ! Proffessor
// The following imports work because the version of drop wizard is 2.0.18
// if you are using newer version, imports may need to be adjusted.
import javax.validation.Validator;
import javax.validation.Validation;
import javax.validation.ValidatorFactory;

// with these imports i can create a validator instance
...
public class GameAuthApplication extends Application<Configuration> {
    ...
    // this new constuctor is needed to create a validator instance
    public GameAuthApplication() {
